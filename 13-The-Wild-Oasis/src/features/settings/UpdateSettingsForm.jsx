...
function UpdateSettingsForm() {
  const {isLoading,settings:{minBookingLength,maxLengthBooking,maxGuestsPerBooking,breakfastPrice}={}} = useSettings();
  ...
  return (
    <Form>
      ...
      <FormRow label="Maximum nights/booking">
        <Input type="number" id="max-nights" disabled={isUpdating} defaultValue={maxLengthBooking} onBlur={(e)=>handleUpdate(e,'maxLengthBooking')}/>
      </FormRow>
